...
library("mice")
library("dplyr")
pretreated_dataset <- read.csv("/home/mathews/Documents/unsurpevisedLearning/HTE/data/filtreatedAndTreatedData.csv", header = TRUE)
```
...
#TEST, DELETE
tempData <- mice(pretreated_dataset, predictorMatrix=predM, m=m_,maxit=1,meth= "pmm",seed=500)
